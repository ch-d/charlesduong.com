  ...
  >
    ...
    <Section py={[2, 3]}>
      <TextBox>
        ...
        <Para>
          In partial fufillment of my Bachelor of Arts degree at Cal Poly, I
          spent time exploring ways to create a Lean workflow in Visual Effects
          / Animation pipelines. After modeling and rigging a vehicle in
          Autodesk Maya, I used MATLAB and Python scripts to analyze terrain
          coordinates for animated vehicle suspension tests. This project taught
          me that there can be a marriage between technology and art.
        </Para>
        <script
    ...
    <Section py={[2, 3]}>
      <TextBox>
        ...
        <Para>
          ...
          concept of creating, sharing and telling. While working on this
          project, I delved into understanding animation language and
          rotoscoping for composition plates.
        </Para>
        <script
    ...
    <Section py={[2, 3]}>
      <TextBox>
        ...
        <Para>
          ...
          comp for the binoculars that would be a lens for the protagonist to
          see the people around her.
        </Para>
      </TextBox>
