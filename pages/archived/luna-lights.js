  ...
  >
    ...
    <Section py={[3, 4]}>
      <TextBox>
        ...
        <Para>
          ...
          interaction between the night time staff and the day time staff.
          Strong communication was present between the staff members throughout
          the day, but it seemed to break down during shift changes. With this
          in mind, we explored ways to help day time staff members to easily
          observe any anomalies when they first come into work.
        </Para>
      </TextBox>
      <ImagesTwo
        images={[
    ...
    <Section py={[3, 4]}>
      <TextBox>
        ...
        <Para>
          ...
          , which helped us create a hierarchy where urgent hourly data was at
          the top, a daily view of all residents came next, and any individual
    ...
    <Section py={[3, 4]}>
      <TextBox>
        <H2>Hourly View</H2>
        <Para>
          Their current API gave us the option to make GET requests for
          timestamps of when residents got in and out of bed, as well as any
          alerts sent to caregivers the night before. (Alerts are sent when
          residents are out of bed for a predetermined amount of time.) After
          several iterations, we determined the best way to display this data
          was in the form of something similiar to a gannt chart.
        </Para>
      </TextBox>
    ...
    <Section py={[3, 4]}>
      <TextBox>
        <H2>Daily View</H2>
        <Para>
          While iterating on the daily view, I saw myself repeating processes
          and looked for ways to design a better flow for creating prototypes.
          Using new nested symbols Sketch feature, I worked on a system of
          symbols and styles that represented each state the view could be. I
          then exported it out to a Dropbox folder and synced it up with an{" "}
    ...
    <Section py={[3, 4]}>
      <TextBox>
        ...
        <Para>
          ...
          could navigate to a card with individual hourly, daily, and numbers.
          The resident view placed precendent in the line graph and hard numbers
          over the urgent hourly view. This gave the day time staff a means for
          more thoughtful interactions of long-term trends for individual
          residents.
        </Para>
      </TextBox>
      <Image
    ...
    <Section py={[3, 4]}>
      <TextBox>
        ...
        <Para>
          ...
          where to start. But as time went on, each challenge became a little
          more clear. We did not have time to implement the designs as code, but
          it was a strong exercise in understanding design tools and workflows.
        </Para>
      </TextBox>
      <Image
        src="../static/luna-lights/007.png"
        caption="Final Dashboard View"
      />
      <ImagesTwo
        images={[
          {
