...
export default () => (
  <Layout
    ...
    categories={[
      ...
      { type: "item", text: "Catrina, Product Manager" },
      { type: "item", text: "Paige, Marketing Manager" },
      { type: "item", text: "Liz, Sociologist" },
      { type: "item", text: "Daniel, JS Web Developer" },
    ...
    <Section>
      <TextBox>
        ...
        <Para>
          ...
          only gave interviewers the ability to reference, take notes during,
          and score interviews. A missing function recruiters and hiring
          managers sought was the ability to review resumes on the app. The
          resume redaction flow for web did not involve too many steps, so we
          decided to explore what this feature would look like in a mobile
          context.
        </Para>
      </TextBox>
      <Image
      ...
      <TextBox>
        ...
        <Para>
          ...
          Ultimately, we decided the value proposition was not strong enough,
          especially with the amount of engineering needed to be implemented. We
          icebox-ed the feature and would take a look at it again another date.
        </Para>
      </TextBox>
    </Section>
    ...
    <Section bg={theme.colors.blue[10]}>
      <TextBox>
        ...
        <Para>
          ...
          manager personas often felt intimidated by the hiring process. They
          had very few interview experiences (at least from the hiring side) and
          mostly took advice from past experiences being interviewed. To help,
          we wanted to provide job templates (with pre-filled job criteria).
          From there, we could provide a structured path to create and maintain
          a job requisition.
        </Para>
        <Para>
          The flow consisted of a job that had candidates, interviewers,
          criteria (which had questions), and rounds (which included its own set
          of candidates, interviewers, criteria, and questions).
        </Para>
      </TextBox>
      <Image
    ...
    <Section>
      <TextBox>
        <Para>
          ...
          components. In doing so, we could ship the feature first, and iterate
          from there. Down the road, we want to explore a more dashboard-like
          view for jobs and tab bar navigation for candidates, criteria, and
          team member sections. We also hope to explore other interactions for
          lists like: swipe interactions for editing, drag and drop, and
    ...
    <Section bg={theme.colors.blue[10]}>
      <TextBox>
        ...
        <Para>
          ...
          designs also came up. Since they already had common components in
          their code, I created a design system within Sketch and collaborated
          with the Product Manager using Abstract. With a component system and
          version control for designs, we turned around mockups quicker and had
          a more efficient feedback loop when a feature story came in. This
          ensured more time focused on success metrics and usability rather than
    ...
    <Section bg={theme.colors.blue[10]}>
      <TextBox>
        ...
        <Para>
          ...
          business goals and create informative illustrations for their
          marketing & sales teams. Blockframes became the main hero in the
          graphics and showcased certain features in development and within the
          current app. Other illustrations addressed a need to humanize the
          hiring process, while retaining context to the technology that powered
          it.
        </Para>
      </TextBox>
    </Section>
