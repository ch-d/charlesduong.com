...
export default () => (
  ...
  >
    ...
    <Image
      img="../static/talent-sonar/001.png"
      cap="Mobile Interview Planning Flow (1 of 2)"
    />
    ...
    <Cap mt={[1, 0]} mb={3}>
      *Hold the alt key while moving your cursor—to pinch in prototype.
    </Cap>
    ...
    <Image
      img="../static/talent-sonar/002.png"
      cap="Mobile Interview Planning Flow (1 of 2)"
    />
    <Image
      img="../static/talent-sonar/003.png"
      cap="Mobile Interview Planning Flow (2 of 2)"
    />
    <Textbox>
      <Para>
    ...
    <Image
      img="../static/talent-sonar/004-1.png"
      cap="Add New Job + Job Criteria Flow"
    />
    <Image
      img="../static/talent-sonar/004-2.png"
      cap="Job Candidates + Job Team Members"
    />
    <Image
      img="../static/talent-sonar/004-3.png"
      cap="Round Candidates + Round Team Members"
    />
    ...
    <Imagegrid
      img1="../static/talent-sonar/006.png"
      cap1="Abstract Version Control (1 of 2)"
      img2="../static/talent-sonar/007.png"
      cap2="Abstract Version Control (2 of 2)"
    />
    ...
    <Image
      img="../static/talent-sonar/016.png"
      cap="Talent Sonar Platform Overview"
    />
  </Layout>
);
