...
export default () => (
    ...
    <Box width={[1, 1/2, 1/3]} py={[0,2,3]} my={[0,2,4]}>
      <Paragraph mb={[4,2]}>
        Hi, I’m Charles&mdash;a designer 👨‍💻 who works on the world wide web. Especially thinking about design systems, research, and tooling. Continuously interested in making technology a little more human, accessible, and inclusive.
      </Paragraph>
      <Paragraph>
