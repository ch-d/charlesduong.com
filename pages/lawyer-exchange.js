  ...
  >
    ...
    <Section py={[2, 3]}>
      <TextBox>
        ...
        <Para>
          ...
          industries, this concept was not widely adopted in the legal
          profession. Even though there were formal opinions and{" "}
          ...
          developed a marketing site that captured emails from potential
          lawyers. We hoped to engage professional attorneys with resources to
          help them understand how this could be a feasible and ethical model to
          work together.
        </Para>
      </TextBox>
      <Image
    ...
    <Section py={[2, 3]}>
      <TextBox>
        ...
        <Para>
          Once we found proficient need for the product, we worked through a
          high level flow of what the app would look like. We defined our users
          as established Solo / Small Firm Lawyers and emerging Recent Law
          School Grads. It became our main priority to provide as much of a
          frictionless experience for the established lawyers who are pressed
          for time, and an extensive toolkit for the emerging lawyers looking to
          grow their career. With a high-level flow established, I then focused
          on wireframing key moments in the flow before diving into{" "}
          <strong>Sketch</strong> for higher fidelity mockups.
        </Para>
      </TextBox>
      <Image
    ...
    <Section py={[2, 3]}>
      <TextBox>
        ...
        <Para>
          I also used Sketch’s symbols to create information architecture maps
          of the product to ensure we were all on the same page. These maps of
    ...
    <Section py={[2, 3]}>
      <TextBox>
        ...
        <Para>
          ...
          Hiring Lawyers, it was important to identify quality Project Lawyers
          at a quick glance. For Project Lawyers, it was important for us to
          help guide them towards making a quality profile. Based on research
          from the{" "}
          ...
          qualities like GPA and class rank. By identifying a lawyer’s
          "Character Quotient", it was our hope to facilitate longer lasting
