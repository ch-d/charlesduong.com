...
export default () => (
  ...
  >
    ...
    <Textbox>
      <Para>
        Luna Lights is an automated lighting system that utilizes cloud based
        data analytics to prevent and detect falls in the older adult
        population. In March 2016, they recorded data on their personal backend
        system, but the only method of report was through screen­shots from a
        third party extension, Mixpanel. The goal for this project was to design
        a streamlined way for care providers to interact with data about their
        residents and further inform better care for older adults.
      </Para>
    </Textbox>
    ...
    <Imagegrid
      img1="../static/luna-lights/001.png"
      cap1="Whiteboard Ideation"
      img2="../static/luna-lights/002.png"
      cap2="Notebook Ideation"
    />
    ...
    <Image
      img="../static/luna-lights/004.gif"
      cap="Sketch Nested Symbol Process"
    />
    <Imagegrid
      img1="../static/luna-lights/005.png"
      cap1="Daily View Prototype"
      img2="../static/luna-lights/006.png"
      cap2="Resident View Prototype"
    />
    ...
    <Imagegrid
      img1="../static/luna-lights/008.gif"
      cap1="Final Hourly View"
      img2="../static/luna-lights/009.gif"
      cap2="Final Daily View"
    />
  </Layout>
);
