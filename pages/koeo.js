  ...
  >
    <Flex wrap py={4}>
      <Description>
        ...
        <Para>
          From an early age, I had the privilege to question and to wonder. My
          curiosity for a world outside my own started with books and reading.
          But, the act of physically being somewhere new and learning from
          people with different experiences was the greatest privilege of all.
          It was through traveling where I began to appreciate human connections
          with folks who had their own human stories.
        </Para>
        <Para>
          Koeo is a simple group trip planning application and an opportunity to
          facilitate an exchange of authentic experiences. Users can collaborate
          with friends and family to organize future travel plans—from planning
          to mundane parts like transportation to planning exciting events. With
          more efficiency in the planning process, I time can be given back to
          all travelers so they can be fully present in the ephemeral moments of
          travel.
        </Para>
      </Description>
      <Flex>
    ...
    <Textbox>
      <Para>
        ...
        I started with designs on <strong>Figma</strong>, but found an
        ...
        <strong>Firebase</strong>, and deployed via <strong>Zeit's Now</strong>.
    ...
    <Imagegrid
      img1="../static/koeo/001.gif"
      cap1="Add a Trip + Unsplash API"
      img2="../static/koeo/002.gif"
      cap2="Inline Edit Trip Details"
    />
    ...
    <Textbox>
      ...
      <Para>
        ...
        Google, and Fourquare APIs. We landed on <strong>Foursquare</strong> for
        its extensive data on venues and lists. I developed an integration that
        fetched Foursquare venue information and displayed in plan details.
        Plans added to the trip were added to Firebase, where users could later
        edit the plan details via a modal.
      </Para>
      <Para>
    ...
    <Image
      showBorder="true"
      img="../static/koeo/003.gif"
      cap="Add a Plan + Foursquare API"
    />
    ...
    <Textbox>
      ...
      <Para>
        ...
        flight information. Unfortunately, we found most flight APIs and data to
        be quite expensive. Since we only wanted to test the feature for the
        time being, we chose to integrate an open-source API,{" "}
        <a href="https://skypickerpublicapi.docs.apiary.io/">Skypicker</a>. I
        developed autocomplete inputs to search for flight info given Airline &
        Airport IATA code data.
      </Para>
    </Textbox>
    <Image
      showBorder="true"
      img="../static/koeo/005.gif"
      cap="Autocomplete Flight Details"
    />
    ...
    <Textbox>
      ...
      <Para>
        ...
        better my designer-developer communication skills. In future updates, we
        will look at more flexible designs (possibly with a draggable and
        efficient timeline view). We also plan to refine the UX of lodging and
        transportation plans—events are usually flexible, but pre-trip planning
        is usually more complicated. And, depending on traveler needs, we have
