  ...
  >
    <Flex wrap py={4}>
      <Description>
        ...
        <Para>
          The Lawyer Exchange is a new venture from the founder of VisaNow to
          answer the question: why are most people who need legal work not able
          to access affordable services? Through initial research, he determined
          the first step should be to help small / solo firm lawyers grow their
          practice by introducing them to freelance lawyers looking for
          meaningful legal experiences.
        </Para>
        <Para>
          The immediate goal was to facilitate the bringing together of these
          legal professionals in similar ways Thumbtack and UpWork provide
          service professionals to consumers. Our assumption was that the
          increased efficiency and flexibility for smaller firms should in turn
          decrease the average cost to access legal services.
        </Para>
        <Para>
          I was the first person to work full-time with the founder when it was
          only an idea in the Fall of 2016. Together, we collaborated with
          emerging lawyers and a development team to ship the initial MVP a year
          later.
        </Para>
      </Description>
      <Flex>
    ...
    <Image
      ...
      cap="Responsive Website Development"
    />
    ...
    />
    <Imagegrid
      img1="../static/lawyer-exchange/018.png"
      cap1="Wireframe Exploration (1 of 2)"
      img2="../static/lawyer-exchange/019.png"
      cap2="Wireframe Exploration (2 of 2)"
    />
    ...
    <Imagegrid
      img1="../static/lawyer-exchange/007.png"
      cap1="Proposal Screen v1"
      img2="../static/lawyer-exchange/008.png"
      cap2="Profile Wizard Screen v1"
    />
    <Imagegrid
      img1="../static/lawyer-exchange/009.png"
      cap1="In-Person User Testing"
      img2="../static/lawyer-exchange/010.png"
      cap2="Remote User Testing"
    />
    ...
    <Textbox>
      ...
      <Para>
        ...
        the product to ensure we were all on the same page. Based on a mix of
        methods from{" "}
        <a href="https://www.youtube.com/watch?v=YrtPH9OWtPE">Joel Buekelman</a>{" "}
        and{" "}
        <a href="https://signalvnoise.com/posts/1926-a-shorthand-for-designing-ui-flows">
          Ryan Singer
        </a>
        , I developed maps of different moments within the UI. This wasn’t meant
        to be a source of truth, rather used to communicate interactions on a
        page and unite the developers and myself around a more common language.
      </Para>
    </Textbox>
    <Imagegrid
    ...
    <Imagegrid
      img1="../static/lawyer-exchange/012.png"
      cap1="Profile Wizard"
      img2="../static/lawyer-exchange/011.png"
      cap2="Profile Editor"
    />
    <Image
