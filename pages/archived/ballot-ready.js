    ...
    <Section py={[3, 4]}>
      <TextBox>
        ...
        <Para>
          ...
          of BallotReady, because they were already politically engaged
          citizens, but didn’t have resources to vote informed all the way down
          the ballot. In counties like Cook County, Illinois, there were upwards
          of 100 positions to vote on, and it was often difficult to determine
    ...
    <Section py={[3, 4]}>
      <TextBox>
        ...
        <Para>
          ...
          "trendy" graphics with BallotReady’s database of over 13,000
          candidates. Our goal with these ads were to reach those less
          politically engaged, and could portray the image of voting informed in
          a more positive light.
        </Para>
      </TextBox>
      <Image
        src="../static/ballot-ready/006.png"
        caption="Newsletter Graphic"
      />
      <ImagesTwo
        images={[
          {
      ...
      />
      <Image
        src="../static/ballot-ready/003.png"
        caption="Blog Post Bar Graph"
      />
    </Section>
  </Layout>
);
